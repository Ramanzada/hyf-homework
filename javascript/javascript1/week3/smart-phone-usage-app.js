...
function showStatusToday() {
    ...
    if (activities.length === 0) {
        ...
        if (todayActivities.length !== 0) {
            console.log(`You have added ${todayActivities.length} activities today. They amount to ${sumDuration} min of usage. That is ${(( sumDuration * 100 ) / minutesInDay).toFixed(2) }% of daily time.`);
        }
